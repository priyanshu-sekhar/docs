...
<Note>
  For clients requiring more control or integration with existing Snowflake infrastructure, consider a [Direct Share](/cloud-delivery/snowflake-direct-share) instead.
</Note>
