...
<Note>
  ...
  - [Snowflake](https://deliveryhub.parametasolutions.com/tabs/indicative-data/our-datawarehouse/accessing-our-data)
  - [WebSocket for Indicative data](https://deliveryhub.parametasolutions.com/tabs/indicative-data/realtime-data/connecting-via-json-websocket)
  - [WebSocket for Trade and Order](https://deliveryhub.parametasolutions.com/tabs/trade-and-order/realtime/trade-websocket)
  - [SFTP](https://deliveryhub.parametasolutions.com/tabs/our-technologies/direct-delivery/snap-files#parameta-sftp)
  - [FIX](https://deliveryhub.parametasolutions.com/tabs/indicative-data/realtime-data/connecting-via-surfix)
</Note>
...
<Tabs>
  <Tab title="VS Code">
    <Steps>
      <Step title="Get our MCP server URL">
        This is: `https://deliveryhub.parametasolutions.com/mcp`
      </Step>
        ...
        ```json
        {
          "servers": {
            "parameta-solutions-documentation": {
              "type": "http",
              "url": "https://deliveryhub.parametasolutions.com/mcp"
            }
          }
        }
        ```
  ...
  <Tab title="Cursor">
    <Steps>
      <Step title="Get our MCP server URL">
        Ours is: `https://deliveryhub.parametasolutions.com/mcp`
      </Step>
  ...
  <Tab title="Claude Code">
    ...
    ```bash
    claude mcp add --transport http Parameta Solutions Documentation https://deliveryhub.parametasolutions.com/mcp
    ```
  ...
  <Tab title="Kiro CLI">
    ...
    ```shellscript
    kiro-cli mcp add --name parametadeliveryhub --url https://deliveryhub.parametasolutions.com/mcp
    ```
  </Tab>
</Tabs>
